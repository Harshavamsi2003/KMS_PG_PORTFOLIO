...
const branches = [
  {
    ...
    photos: Array.from({ length: 10 }, (_, i) => `/assets/KMS/MEN/B1/${i + 1}.jpg`),
    main: true,
  },
  {
    id: 'B2',
    ...
    photos: Array.from({ length: 10 }, (_, i) => `/assets/KMS/MEN/B2/${i + 1}.jpg`),
    main: false,
  },
  {
    id: 'B3',
    ...
    photos: Array.from({ length: 11 }, (_, i) => `/assets/KMS/MEN/B3/${i + 1}.jpg`),
    main: false,
  },
  {
    id: 'B4',
    ...
    photos: Array.from({ length: 12 }, (_, i) => `/assets/KMS/MEN/B4/${i + 1}.jpg`),
    main: false,
  },
  {
    id: 'WB1',
    ...
    photos: Array.from({ length: 15 }, (_, i) => `/assets/KMS/WOMEN/B1/${i + 1}.jpg`),
    main: false,
      ...
      <div className="container">
            ...
            >
              ...
              <div className="br-card-head">
                <div className="br-tag-row">
                  ...
                  {b.main && <span className="br-badge-main">Main Branch</span>}
              ...
              {b.extraNote && (
                <div className="br-note">{b.extraNote}</div>
              )}
              ...
              <div className="br-actions">
                ...
                <a href={`https://wa.me/${WA}?text=${WA_MSG}`} target="_blank" rel="noopener noreferrer" className="br-btn br-btn-wa" aria-label="WhatsApp">
                  <IconWA />
                </a>
              </div>
            </article>
        ...
        <div className="br-contact-strip rv">
          ...
          <div className="br-contact-item">
            ...
            <a href="mailto:kmuruganandam1975@gmail.com" className="br-contact-val">kmuruganandam1975@gmail.com</a>
          </div>
