    ...
    <section className="branches" id="branches" ref={sectionRef}>
      ...
      <div className="container">
        ...
        <div className="br-hdr rv">
          ...
          <h2 className="sec-title">7 Branches in <em>Ramapuram</em></h2>
        ...
        <div className="br-contact-strip rv">
          <div className="br-contact-rows">
            <a href="tel:+919710669944" className="br-contact-row">
              <span className="br-contact-icon"><IconPhone /></span>
              <span className="br-contact-text">
                <span className="br-contact-label">Primary Contact</span>
                <span className="br-contact-val">+91 97106 69944</span>
              </span>
            </a>
            <div className="br-contact-divider" />
            <a href="tel:+918825733398" className="br-contact-row">
              <span className="br-contact-icon"><IconPhone /></span>
              <span className="br-contact-text">
                <span className="br-contact-label">Alternate Contact</span>
                <span className="br-contact-val">+91 88257 33398</span>
              </span>
            </a>
            <div className="br-contact-divider" />
            <a href="mailto:kmuruganandam1975@gmail.com" className="br-contact-row">
              <span className="br-contact-icon"><IconMail /></span>
              <span className="br-contact-text">
                <span className="br-contact-label">Email Us</span>
                <span className="br-contact-val br-contact-val--email">kmuruganandam1975@gmail.com</span>
              </span>
            </a>
          </div>
